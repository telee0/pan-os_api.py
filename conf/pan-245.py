...
cf.update({
    ...
    'N_NET_IF_ETHERNET': 0,  # number of subinterfaces per each physical ethernet
    'N_NET_IF_LOOPBACK': 0,
    'N_NET_IF_TUNNEL': 0,
    'N_NET_ZONES': 0,
...
cf.update({
    ...
    # 'N_NET_IF_ETHERNET': 0,
    'IF_ETHERNET_LIST': ["ethernet1/13", "ethernet1/14"],  # to be developed to replace IF_ETHERNET_NAME
    ...
    'IF_ETHERNET_ZONE': cf['DEFAULT_ZONE1'],

    # 'N_NET_IF_LOOPBACK': 0,
    # 'IF_LOOPBACK_IP': "",
    'IF_LOOPBACK_IP': "100.{}.{}.1",  # 100.$i.$j.1/32
    ...
    'IF_TUNNEL_ZONE': cf['DEFAULT_ZONE1'],
    ...
    # 'IKE_INTERFACE': "loopback.{}",  # loopback or ethernet sub/interfaces
    # 'IKE_IP_LOCAL': "127.{}.{}.1",
    # 'IKE_IP_PEER': "127.{}.{}.2",
    'IKE_INTERFACE': "ethernet1/2",  # loopback or ethernet sub/interfaces
    ...
    # 'N_NET_IPSEC': 1200,
    'IPSEC_NAME': "IPSec_Tunnel-{}",  # IPSec_Tunnel-$i
    'IPSEC_TUNNEL_INTERFACE': 'tunnel.{}',  # Tunnel interface
    # 'IPSEC_IKE_GATEWAY': "IKE_Gateway-{}",  # IKE_Gateway-$i
    ...
    'IPSEC_IP_LOCAL': "1.1.%d.%d",  # 172.16.$i.$j
    'IPSEC_IP_LOCAL_PREFIX': "/24",
    'IPSEC_IP_REMOTE': "2.2.%d.%d",  # 192.168.$i.$j
